...
public final class I18n {
        ...
        private static Map<String, String> createZhMessages() {
                ...
                m.put("aiSettings.checkbox.projectContext", "启用项目上下文增强");
                ...
                m.put("aiSettings.index.status.disabled", "未启用");
                m.put("aiSettings.index.filesIndexed", "已索引文件:");
                m.put("aiSettings.index.chunksIndexed", "已索引代码块:");
                m.put("aiSettings.index.lastUpdate", "最后更新:");
                ...
                m.put("aiSettings.checkbox.fimEnabled", "启用 FIM 补全格式");
                m.put("aiSettings.label.fimPrefixToken", "FIM Prefix Token:");
                m.put("aiSettings.label.fimSuffixToken", "FIM Suffix Token:");
                m.put("aiSettings.label.fimMiddleToken", "FIM Middle Token:");
                ...
                m.put("aiSettings.validation.fimTokenRequired", "启用 FIM 时必须填写所有 FIM Token");
        ...
        private static Map<String, String> createEnMessages() {
                ...
                m.put("aiSettings.checkbox.projectContext", "Enable project context enrichment");
                ...
                m.put("aiSettings.index.status.disabled", "Disabled");
                m.put("aiSettings.index.filesIndexed", "Files Indexed:");
                m.put("aiSettings.index.chunksIndexed", "Chunks Indexed:");
                m.put("aiSettings.index.lastUpdate", "Last Update:");
                ...
                m.put("aiSettings.checkbox.fimEnabled", "Enable FIM completion format");
                m.put("aiSettings.label.fimPrefixToken", "FIM Prefix Token:");
                m.put("aiSettings.label.fimSuffixToken", "FIM Suffix Token:");
                m.put("aiSettings.label.fimMiddleToken", "FIM Middle Token:");
                ...
                m.put("aiSettings.validation.fimTokenRequired", "All FIM tokens are required when FIM is enabled");
