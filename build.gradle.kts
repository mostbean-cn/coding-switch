...
intellijPlatform {
    pluginConfiguration {
        ...
        description = """
            ...
            <p>Manage Claude Code, Codex, OpenCode, and other AI coding command-line tools in JetBrains IDEs, with inline AI code completion, Git commit message generation, path-with-line-number insertion, CLI quick launch, and CLI version checks.</p>

            <h3>Features</h3>
            <ul>
                <li><b>AI CLI Provider Management</b> — Manage and switch API configurations for Claude Code, Codex, and OpenCode with official APIs, third-party compatible endpoints, local providers, connection tests, and built-in presets.</li>
            ...
            <h3>功能</h3>
            <ul>
                <li><b>AI CLI 配置管理</b> — 管理并切换 Claude Code、Codex、OpenCode 的 API 配置，支持官方接口、第三方兼容接口、本地模型、连接测试和内置供应商预设。</li>
